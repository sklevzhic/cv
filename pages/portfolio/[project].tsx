                ...
                <div className="container px-5 py-12 mx-auto flex flex-wrap">
                    <div className="flex flex-wrap -mx-4 mt-auto mb-auto lg:w-1/2 sm:w-2/3 content-start sm:pr-10">
                        <div className="w-full sm:p-4 px-4 mb-6">
                            <p className="">Набор текста на виртуальной клавиатуреНабор текста на виртуальной
                                клавиатуреНабор текста на виртуальной клавиатуреНабор текста на виртуальной
                                клавиатуреНабор текста на виртуальной клавиатуре</p>
                        </div>
                        <div className="w-full sm:p-4 px-4 mb-6">
                        ...
                        {
                            arr.map(technology => {
                                return <TechnologyItem icon={technology}/>
                            })
                        }
                    ...
                    <div className="lg:w-1/2 sm:w-1/3 w-full rounded-lg overflow-hidden mt-6 sm:mt-0">
                        <img className="object-cover object-center w-full h-full"
                             src="https://sklevzhic.github.io/rsschool-cv/assets/img/my-app.jpg"
                             alt="stats"/>
                    </div>
                </div>
            </section>
